...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar do Murilo" class="rounded-circle" width="200" height="200"
            srcset="">
        <p class="lead">Eu sou Murilo</p>
        <h1>Eu estudo programação</h1>
        <p>Sou estudante do ensino médio. Estou aprendendo programar com o Alura. Já aprendi usar scratch e Pj5s. Estudo sobre HTML, CSS e JavaScript. Veja os projetos
            que já desenvolvi!</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Este projeto é uma página na web sobre livros que eu ja li e recomendo.
                        </p>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Meu jogo favorito do scratch</h5>
                        <p class="card-text">Este projeto é um jogo interativo que foi postado na plataforma do scratch, onde o jogador presisa coletar ovos de páscoa.</p>
